...
[//]: # (| 상품          |     | 상품의 가격, 이름, 상태 등 정보가 한 곳에 모여 상품을 의미함                                    |)

[//]: # (| 상품 가격       |     | 상품의 가격                                                                  |)

[//]: # (| 상품 이름       |     | 상품의 이름                                                                  |)

[//]: # (| 상품 목록       |     | 상품이 한 개가 아닌 여러개가 모인 것                                                   |)

[//]: # (| 상품 상태       |     | 상품이 노출/숨김 상태를 의미                                                        |)

[//]: # (| 상품 이름 비속어   |     | 상품 이름을 정의할 때 기준이 되는 비속어                                                 |)

[//]: # (| 메뉴 그룹       |     | 여러개의 메뉴를 나눠 어느 곳에 모아둔 것                                                 |)

[//]: # (| 메뉴 그룹 이름    |     | 메뉴 그룹의 이름                                                               |)

[//]: # (| 메뉴 그룹 목록    |     | 메뉴 그룹이 한 개가 아닌 여러개가 모인 것                                                |)

[//]: # (| 메뉴          |     | 메뉴의 이름, 가격, 상태 등 정보가 한 곳에 모여 메뉴를 의미함                                    |)

[//]: # (| 메뉴 이름       |     | 메뉴의 이름                                                                  |)

[//]: # (| 메뉴 이름 비속어   |     | 메뉴 이름을 정의할 때 기준이 되는 비속어                                                 |)

[//]: # (| 메뉴 가격       |     | 메뉴의 가격                                                                  |)

[//]: # (| 메뉴 목록&#40;메뉴판&#41;  |     | 메뉴 한 개가 아닌 여러개가 모인 것                                                    |)

[//]: # (| 메뉴 상태       |     | 메뉴가 노출/숨김 상태를 의미                                                        |)

[//]: # (| 메뉴 상품       |     | 메뉴에 등록된 상품 목록이 들어있는 것                                                   |)

[//]: # (| 메뉴 상품 목록    |     | 메뉴 상품이 한 개가 아닌 여러개가 모인 것                                                |)

[//]: # (| 메뉴 상품 수량    |     | 메뉴에 속한 상품의 수량을 의미                                                       |)

[//]: # (| 메뉴 상품 총 가격  |     | 메뉴에 속한 상품이 수량을 포함해 총 가격을 산출                                             |)

[//]: # (| 주문 테이블      |     | 주문 테이블의 이름, 손님 수, 상태 등 정보가 한 곳에 모여 주문 테이블을 의미함                          |)

[//]: # (| 주문 테이블 목록   |     | 주문 테이블 한 개가 아닌 여러개가 모인 것                                                |)

[//]: # (| 주문 테이블 이름   |     | 주문 테이블의 이름                                                              |)

[//]: # (| 주문 테이블 손님 수 |     | 주문 테이블에 앉아 있는 손님의 수                                                     |)

[//]: # (| ~~방문 손님 수~~ |     |                                                                         |)

[//]: # (| 주문 테이블 상태   |     | 주문 테이블의 상태에 따라 손님을 응대 할 수 있음 &#40;빈 테이블, 이용중인 테이블&#41;                          |)

[//]: # (| 주문&#40;주문서&#41;     |     | 주문의 유형, 상태, 가격, 주소 등 정보가 한 곳에 모여있는 것을 의미함                               |)

[//]: # (| 배달 대행사      |     | 메뉴를 손님에게 전달해주는 역할                                                       |)

[//]: # (| 배달 대행사 호출   |     | 배달 대행사를 호출                                                              |)

[//]: # (| 배달 메뉴 인계    |     | 손님이 주문한 메뉴를 배달 대행사에게 주문서와 함께 전달                                         |)

[//]: # (| 배달 주소       |     | 배달 주문 요청으로 손님의 주소지를 의미                                                  |)

[//]: # (| 주문 메뉴 가격    |     | 손님이 주문한 메뉴의 가격                                                          |)

[//]: # (| 주문 메뉴 총 가격  |     | 손님이 주문한 메뉴의 총 가격                                                        |)

[//]: # (| 주문 유형       |     | 손님이 주문 유형을 선택할 수 있음. &#40;배달, 포장, 매장&#41;                                       |)

[//]: # (| 주문 상태       |     | 손님이 주문한 상품을 접수부터 완료까지 상태를 표출함<br/>&#40;접수 대기, 접수, 서빙, 배달, 배달 완료, 완료, 매장, 포장&#41; |)
